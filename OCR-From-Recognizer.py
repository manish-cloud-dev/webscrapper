...
#from python_pyimagesearch.alignment import align_images
...
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\coder\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'
...
args = vars(ap.parse_args(["-t","form.png","-i","form.png"]))
...
OCR_LOCATIONS = [
OCRLocation("step1_first_name", (35, 162, 305, 100),
    ["middle", "initial", "first", "name"]),
OCRLocation("another_name", (202,336,90, 50),
    ["anothername"]),
]
...
#cv2.imshow("Output", imutils.resize(image, width=700))
#cv2.waitKey(0)
